...
class _HomeWidgetState extends State<HomeWidget> {
  ...
  void initState() {
    ...
    MySharedPreferences.getFirebaseUID().then((uid){
      Firestore.instance.collection("users").document(uid).get().then((DocumentSnapshot data){
        setState(() {
    ...
    return Row(
      ...
      children: <Widget>[
        Material(
            ...
            child: CircleAvatar(
                radius: 40.0,
                backgroundImage: NetworkImage("https://booth.pximg.net/c3d42cdb-5e97-43ff-9331-136453807f10/i/616814/d7def86b-1d95-4f2d-ad9c-c0c218e6a533_base_resized.jpg")
            )
        ),
      ],
    );
      ...
      child: Material(
        ...
        child: Column(
          children: <Widget>[
            ...
            Text(this.displayName, style: Theme.of(context).textTheme.title,),
            SizedBox(height: 5.0,),
            Text(this.email),
